...
@implementation DownLoadCacheModel
...
+ (NSString *)systemMsgCachePath
{
    ...
    NSString *str = [NSString stringWithFormat:@"%@WebCarData",path];
    return  str;
}
...
- (NSMutableDictionary *)tempVersions{
    if (!_tempVersions) {
        _tempVersions = [NSMutableDictionary dictionary];
    }
    return _tempVersions;
}
@end
