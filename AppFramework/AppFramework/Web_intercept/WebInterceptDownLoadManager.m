...
- (NSString *)pathWithFolder:(NSURL *)url{
    ...
    NSString *patientPhotoFolder = [[WebInterceptDownLoadManager shareInstance].basePath?:CYXCachesDirectory stringByAppendingPathComponent:[WebInterceptDownLoadManager shareInstance].folder?:@"webIntercept"];
    ...
    NSString * fileName = [AppFrameworkTool md5:absoluteString];
    fileName            = [fileName stringByAppendingString:[AppFrameworkTool fileFormat:url.lastPathComponent]];
